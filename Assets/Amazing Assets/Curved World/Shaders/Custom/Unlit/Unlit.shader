Shader "Amazing Assets/Curved World/Unlit"
{
    Properties
    {
        [CurvedWorldBendSettings] _CurvedWorldBendSettings("0,1,2,3,15,29|1", Vector) = (0, 0, 0, 0)
...
#pragma shader_feature_local CURVEDWORLD_BEND_TYPE_CLASSICRUNNER_X_POSITIVE CURVEDWORLD_BEND_TYPE_CLASSICRUNNER_X_NEGATIVE CURVEDWORLD_BEND_TYPE_CLASSICRUNNER_Z_POSITIVE CURVEDWORLD_BEND_TYPE_CLASSICRUNNER_Z_NEGATIVE CURVEDWORLD_BEND_TYPE_SPIRALHORIZONTALDOUBLE_X CURVEDWORLD_BEND_TYPE_TWISTEDSPIRAL_Z_POSITIVE
